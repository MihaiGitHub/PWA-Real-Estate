...
<div className="navigation">
              ...
              <div className="row">
                <div className="col-md-4 col-sm-4">
                  <div className="feature-box equal-height">
                    <figure className="icon"><i className="fa fa-folder" /></figure>
                ...
                <div className="col-md-4 col-sm-4">
                  <div className="feature-box equal-height">
                    <figure className="icon"><i className="fa fa-users" /></figure>
                    <aside className="description">
                ...
                <div className="col-md-4 col-sm-4">
                  <div className="feature-box equal-height">
                    <figure className="icon"><i className="fa fa-money" /></figure>
                    <aside className="description">
              ...
              <a href="submit.html">
                <div className="banner">
                  <div className="wrapper">
                    ...
                    <span className="submit">Submit it now! <i className="fa fa-plus-square" /></span>
                  </div>
                </div>{/* /.banner*/}
              </a>
            </div>
        ...
        <footer id="page-footer">
          <div className="inner">
            ...
            <aside id="footer-thumbnails" className="footer-thumbnails" />{/* /#footer-thumbnails */}
